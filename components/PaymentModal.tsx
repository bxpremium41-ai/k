        ...
        <div className="hidden md:flex w-[42%] bg-gray-900 text-white p-10 flex-col justify-between relative overflow-hidden">
            ...
            <div className="relative z-10 pt-6">
                 <div className="bg-white/5 p-4 rounded-2xl border border-white/10 backdrop-blur-sm">
                     <p className="text-sm text-gray-300 italic mb-3">"I reduced my rendering time from 12 hours to 10 minutes using the Hybrid pipeline."</p>
                     <div className="flex items-center gap-2">
                         <div className="w-6 h-6 rounded-full bg-gray-200 text-gray-900 flex items-center justify-center text-xs font-bold">SJ</div>
                         <span className="text-xs font-bold text-white">Sarah J., Architect</span>
                     </div>
                 </div>
            </div>
        </div>
                ...
                {(viewState === 'FORM' || viewState === 'PROCESSING') && (
                    <div className="space-y-6">
                        ...
                        <div className="md:hidden text-[11px] font-black text-brand-primary uppercase tracking-[0.25em] mb-4 text-center bg-brand-primary/5 py-3 rounded-xl border border-brand-primary/10 shadow-sm">
                            All Software Download Included
                        </div>
